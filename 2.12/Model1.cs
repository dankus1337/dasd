    ...
    public partial class Model1 : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<client>()
                .HasMany(e => e.tag)
                .WithMany(e => e.client)
                .Map(m => m.ToTable("tagofclient", "112").MapLeftKey("ClientID").MapRightKey("TagID"));
            ...
            modelBuilder.Entity<product>()
                ...
                .Map(m => m.ToTable("attachedproduct", "112").MapLeftKey("MainProductID").MapRightKey("AttachedProductID"));
